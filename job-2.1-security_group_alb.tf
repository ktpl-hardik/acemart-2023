...
##### This SG will add after ALB and Auto Scaling Configuration ######  
    # {
      # description      = "NFS from Magento Backend ALB SG"
      # protocol         = var.acemart_prod_sg_ingress_proto
      # from_port        = var.acemart_prod_sg_ingress_nfs
      # to_port          = var.acemart_prod_sg_ingress_nfs
      # cidr_blocks      = []
...
##### This SG will add after ALB and Auto Scaling Configuration ######  
    # {
      # description      = "MySQL from Magento Internal ALB SG"
      # protocol         = var.acemart_prod_sg_ingress_proto
      # from_port        = var.acemart_prod_sg_ingress_mysql
      # to_port          = var.acemart_prod_sg_ingress_mysql
      # cidr_blocks      = []
    ...
    # },
    {
      description      = "MySQL from Magento Backend ALB SG"
      protocol         = var.acemart_prod_sg_ingress_proto
      from_port        = var.acemart_prod_sg_ingress_mysql
      to_port          = var.acemart_prod_sg_ingress_mysql
      cidr_blocks      = []
    ...
    {
      description      = "MySQL from 3rd party inventory management system"
      protocol         = var.acemart_prod_sg_ingress_proto
      from_port        = var.acemart_prod_sg_ingress_mysql
      to_port          = var.acemart_prod_sg_ingress_mysql
      cidr_blocks      = ["50.56.220.234/32"]
    ...
    {
      description      = "SSH connection from 3rd party inventory management system"
      protocol         = var.acemart_prod_sg_ingress_proto
      from_port        = var.acemart_prod_sg_ingress_ssh
      to_port          = var.acemart_prod_sg_ingress_ssh
      cidr_blocks      = ["50.56.220.234/32"]
    ...
    {
      description      = "MySQL from Acemart Corporate LB IP - 1"
      protocol         = var.acemart_prod_sg_ingress_proto
      from_port        = var.acemart_prod_sg_ingress_mysql
      to_port          = var.acemart_prod_sg_ingress_mysql
      cidr_blocks      = ["64.132.229.66/32"]
    ...
    {
      description      = "MYSQL from Acemart Corporate LB IP - 2"
      protocol         = var.acemart_prod_sg_ingress_proto
      from_port        = var.acemart_prod_sg_ingress_mysql
      to_port          = var.acemart_prod_sg_ingress_mysql
      cidr_blocks      = ["184.80.232.34/32"]
...
resource "aws_security_group" "cache_sg" {
  ...
  ingress = [
    ...
    ##### This SG will add after ALB and Auto Scaling Configuration ######  
    # {
      # description      = "Elasticsearch Access from Magento Internal ALB SG"
      # protocol         = var.acemart_prod_sg_ingress_proto
      # from_port        = var.acemart_prod_sg_ingress_elasticsearch
      # to_port          = var.acemart_prod_sg_ingress_elasticsearch
      # cidr_blocks      = []
    ...
    # },
  {
      description      = "Elasticsearch Access from Magento Public ALB SG"
      protocol         = var.acemart_prod_sg_ingress_proto
      from_port        = var.acemart_prod_sg_ingress_elasticsearch
      to_port          = var.acemart_prod_sg_ingress_elasticsearch
      cidr_blocks      = []
    ...
    {
      description      = "NFS from Magento Backend Public ALB SG"
      protocol         = var.acemart_prod_sg_ingress_proto
      from_port        = var.acemart_prod_sg_ingress_redis
      to_port          = var.acemart_prod_sg_ingress_redis
      cidr_blocks      = []
...
resource "aws_security_group" "pwa_sg" {
  ...
  ingress = [
    ...
    {
      description      = "HTTP allow from PWA"
      protocol         = var.acemart_prod_sg_ingress_proto
      from_port        = var.acemart_prod_sg_ingress_http
      to_port          = var.acemart_prod_sg_ingress_http
      cidr_blocks      = []
      ipv6_cidr_blocks = []
      prefix_list_ids  = []
      security_groups  = [aws_security_group.pwa_alb_sg.id ]
      self             = false
    }, 
    {
      description      = "SSH from Acemart Corporate LB IP - 1"
